                    ...
                    <tbody>
                        @foreach ($organizations as $organization)
                            <tr>
                                ...
                                <td><img src="{{ Storage::url($organization->image) }}" width="100"
                                        alt="organization image"></td>
                                ...
                                <td>
                                    <a href="{{ route('organization.destroy', $organization->id) }}">
                                        <form action="{{ route('organization.destroy', $organization->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('DELETE')
